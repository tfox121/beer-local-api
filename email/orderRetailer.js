...
exports.orderRetailer = (avatarSource, bannerSource, businessName, orderItems, orderNumber, orderDate, orderTotal, orderId, options) => mjml2html(`
  <mjml>
      ...
      <mj-section background-color="#598392" padding-bottom="5px" padding-top="0">
        <mj-column width="100%">
          ...
          <mj-text align="center" color="#FFF" font-size="13px" font-family="Helvetica" padding-left="25px" padding-right="25px" padding-bottom="28px" padding-top="0px">
            <span style="font-size:20px; font-weight:bold">Thanks for your order.</span>
            <br/>
            <br/>
            <span style="font-size:15px">Your order has been confirmed. Please find a summary below.</span>
          </mj-text>
        </mj-column>
      </mj-section>
    ...
    `<mj-section background-color="#124559" padding-bottom="15px">
      ...
      <mj-section background-color="#598392" padding-bottom="20px" padding-top="20px">
        <mj-column width="50%">
      ...
      <mj-section background-color="#598392" padding-bottom="5px" padding-top="0">
        <mj-column width="100%">
          ...
          <mj-text align="center" color="#FFF" font-size="15px" font-family="Helvetica" padding-left="25px" padding-right="25px" padding-bottom="20px" padding-top="20px">Best,
            <br/>
            <br/>
            <span style="font-size:15px">The ${businessName} Team</span></mj-text>
        </mj-column>
      </mj-section>
    </mj-body>
  </mjml>
